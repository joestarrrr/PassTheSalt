        ...
        >
          ...
          <div className="flex h-16 flex-shrink-0 items-center gap-3 border-b border-slate-100 px-5">
            ...
            <div className="min-w-0 leading-tight">
              ...
              <p className="text-[10px] font-semibold uppercase tracking-widest text-violet-500">Mob Mode</p>
            </div>
          </div>
        ...
        <div className="flex flex-1 min-w-0 flex-col overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
            <div className="mb-6 lg:mb-8">
              <p className="text-xs font-semibold uppercase tracking-[0.35em] text-violet-500/90">Mob Mode</p>
